...
module CommentsHelper
  ...
  def approve_button(comment)
    link_to (comment.approved && comment.task.is_done? ? 'javascript:;' : approve_comment_path(comment)), class: 'dropdown-item small btn-approve', 'data-approved' => comment.approved.to_s, :title => t('approve') do
